...
int main()
{
    ...
    // ptr পয়েন্টারটি যে ভেরিয়েবল এর মেমোরি এড্রেস কে নির্দেশ করছে ওই ভেরিয়েবল এর ভ্যালুটা প্রিন্ট করে দেখাবে। That means * ব্যাবহার করে আমরা মেমরি এড্রেস নয় বরং ভ্যালু খুজে বের করতে পারবো।
